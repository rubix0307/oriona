...
def parse_pagination(soup: BeautifulSoup) -> PaginationInfo:
    try:
        nav = soup.select_one("div.navigation")
        if not nav:
            return PaginationInfo(current=None, total=None, next=None, next_url=None)
